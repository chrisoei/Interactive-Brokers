...
import com.ib.client.BackfillDuration;
import com.ib.client.BarSizeSetting;
...
public class OrderDlg extends JDialog {
    ...
    private JComboBox	m_BackfillDurationField = new JComboBox(BackfillDuration.getFields());
    private JComboBox	m_BarSizeSettingField = new JComboBox(BarSizeSetting.getFields());        
    ...
    public OrderDlg(DataCollector owner) {
