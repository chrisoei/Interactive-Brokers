...
public class BarSizeSetting {
    ...
    public static String getField( int barSizeSetting) {
     ...
     public static String[] getFields(){
    	int totalFields = BarSizeSetting.class.getFields().length;
    	String [] fields = new String[totalFields];
    	for (int i = 0; i < totalFields; i++){
    		fields[i] = BarSizeSetting.getField(i + 1);
    	}
    	return fields;
    }       
}
