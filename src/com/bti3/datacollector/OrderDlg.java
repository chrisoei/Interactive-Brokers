...
import com.ib.client.BackfillDuration2;
import com.ib.client.BarSizeSetting2;
import com.ib.client.BackfillEndTime;
...
public class OrderDlg extends JDialog {
    ...
    public String       m_backfillDuration2;
    public String       m_barSizeSetting;
    public String       m_BarSizeSetting2;
    public int          m_useRTH;
    ...
    private JComboBox m_BackfillEndTimeField = new JComboBox(BackfillEndTime.getFields());
    private JTextField	m_BackfillDuration = new JTextField( "1 M");
    private JComboBox	m_BackfillDurationField = new JComboBox(BackfillDuration2.getFields());
    //private JTextField  m_BarSizeSetting = new JTextField("1 day");
    private JComboBox	m_BarSizeSettingField = new JComboBox(BarSizeSetting2.getFields());        
    ...
    private JButton 	m_toDbase = new JButton( "Insert Contract Dbase");
    private JButton 	m_ok = new JButton( "OK");
    private JButton 	m_cancel = new JButton( "Cancel");
    
    private DataCollector m_parent;
    private EClientSocket   m_client2 = new EClientSocket(m_parent);
    ...
    public OrderDlg(DataCollector dataCollector) {
    
    	super( dataCollector, true);
    	
        m_parent = dataCollector;
        setTitle( "Hour 11 Analytics");
        ...
        addGBComponent(pBackfill, m_BackfillEndTimeField, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER) ;
        addGBComponent(pBackfill, new JLabel( "Duration"), gbc, COL1_WIDTH, GridBagConstraints.RELATIVE) ;
        addGBComponent(pBackfill, m_BackfillDurationField, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER) ;
        addGBComponent(pBackfill, new JLabel( "Bar Size Setting (1 to 11)"), gbc, COL1_WIDTH, GridBagConstraints.RELATIVE) ;
        addGBComponent(pBackfill, m_BarSizeSettingField, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER) ;
        ...
        */
        m_toDbase.addActionListener( new ActionListener() {
            public void actionPerformed( ActionEvent e) {
            	onInsertToDbase();
            }
        });
    ...
    void onInsertToDbase() {
        ...
        try {
           ...
           // m_backfillEndTime = m_BackfillEndTime.getText();
            m_backfillEndTime = (String) m_BackfillEndTimeField.getSelectedItem();
            m_backfillDuration = (String) m_BackfillDurationField.getSelectedItem();
            m_barSizeSetting = (String) m_BarSizeSettingField.getSelectedItem();
